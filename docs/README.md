...
| [ai.md](ai.md) | `bl ai`: local model emits blackline ops |
| [README § Completely local LLM](../README.md#completely-local-llm) | Why a local GGUF can redline and edit, and where it stops |
...
Start at the root [README](../README.md) for a tour.
